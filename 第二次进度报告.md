...
作为之后工作开展的基础，我们小组成员还继续精度了论文“Detailed human avatars from monocular video”，对其实现的基本步骤做了总结：
...
1. <span id="geman">Geman-McClure函数</span>  
