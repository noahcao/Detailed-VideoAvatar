...
将这些纹素merge到一起就得到了最终的texture
 ![back-project](https://github.com/noahcao/Detailed-Human-Avatars-from-Monocular-Video/tree/master/assets/back-project.png)    
...
1. 代码与论文中的对应关系  
    ...
    ```
    等式：  
    ![equal4](https://github.com/noahcao/Detailed-Human-Avatars-from-Monocular-Video/tree/master/assets/equal4.png)  
