...
from lib.frame import setup_frame_rays,setup_frame_rays_paper2
from lib.rays import ray_objective, ray_face
from lib.geometry import laplacian
from lib.ch import sp_dot
from models.smpl import Smpl
from models.bodyparts import faces_no_hands, regularize_laplace, regularize_model, regularize_symmetry,get_face_vertex_ids
...
def main(pose_file, masks_file, face_file, camera_file, out, obj_out, num, icp_count, model_file, first_frame, last_frame,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'face_file',
        type=str,
        help="File that contains face landmark")
    parser.add_argument(
        'camera',
        type=str,
    ...
    main(args.pose_file, args.masks_file, args.face_file, args.camera, args.out, args.obj_out, args.num, args.icp, args.model,
